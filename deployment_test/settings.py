...
DATATYPE_LOCATIONS.append('deployment_test.datatypes')
FUNCTION_LOCATIONS.append('deployment_test.functions')
ETL_MODULE_LOCATIONS.append('deployment_test.etl_modules')
SEARCH_COMPONENT_LOCATIONS.append('deployment_test.search_components')
...
SECRET_KEY = '!%k7x8wkdk7hweju7=ico8e3mmh=c)xl0zd#u()mrx(8lwacum'
...
ELASTICSEARCH_PREFIX = 'deployment_test'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'deployment_test.search_indexes.sample_index.SampleIndex',
...
SESSION_COOKIE_NAME = 'deployment_test'
